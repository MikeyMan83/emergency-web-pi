...
if not exist "%SCRIPT_DIR%PiKiwixPortable.ps1" (
	...
	powershell -NoProfile -Command "[void][System.Reflection.Assembly]::LoadWithPartialName('System.Windows.Forms'); [System.Windows.Forms.MessageBox]::Show('PiKiwixPortable.ps1 is missing. Extract the full release ZIP and retry.','Pi Offline Library Builder')"
	popd >nul 2>&1
	exit /b 1
)
